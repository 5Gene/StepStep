...
object CoroutineCompleteExample {
    ...
    class PermissionStep2(
        private val permissions: List<String>
    ) : BaseStep<String>() {
        override fun getStepId(): String = "PermissionStep2"
    ...
    suspend fun devicePairingExample() {
        ...
        val engine = StepApi.createStepEngineBuilder<String>()
            .addStep(WelcomeStep())
            .addStep(PermissionStep2(listOf("android.permission.BLUETOOTH")))
    ...
    suspend fun dynamicStepManagementExample() {
        ...
        delay(2000)
        println("动态插入权限步骤")
        engine.insertStep(1, PermissionStep2(listOf("android.permission.CAMERA")))
